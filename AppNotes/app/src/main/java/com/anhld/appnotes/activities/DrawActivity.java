...
import com.anhld.appnotes.drawp_properties.CanvasExporter;
import com.anhld.appnotes.drawp_properties.CanvasView;
import com.anhld.appnotes.drawp_properties.ColourPickerDialog;
import com.anhld.appnotes.drawp_properties.ScaleHandler;
import com.anhld.appnotes.drawp_properties.StorageRationaleDialog;
...
public class DrawActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * The first method called by the application, which handles setting up the UI, scale gestures,
     * touch events, and any listeners which need to be set up.
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scaleGestureDetector = new ScaleGestureDetector(DrawActivity.this, scaleHandler);
    ...
    private void checkForPermissions() {
        ...
        if (permission == PackageManager.PERMISSION_DENIED) {
            ...
            if (shouldShowRationale) {
                ...
                StorageRationaleDialog dialog = new StorageRationaleDialog(DrawActivity.this);
        ...
        if (canvasExporter.getExportType() == CanvasExporter.FLAG_SAVE) {
            ...
            if (fileName != null) {
                ...
                MediaScannerConnection.scanFile(
                        DrawActivity.this, new String[]{fileName}, null, null);
                Toast.makeText(DrawActivity.this, "The image was saved successfully.", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(DrawActivity.this, "There was an error saving the image.", Toast.LENGTH_SHORT).show();
            }
    ...
    private void shareImage() {
        ...
        if (image != null) {
            ...
            Uri uri = FileProvider.getUriForFile(
                    DrawActivity.this,
                    DrawActivity.this.getApplicationContext().getPackageName() +
            ...
            Toast.makeText(DrawActivity.this, "There was an error sharing the image.", Toast.LENGTH_SHORT).show();
        }
    }
}